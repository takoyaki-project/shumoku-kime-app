...
const EVENTS_MASTER = {
  "_note": "さくら町一丁目向け種目マスタ。種目名は『去年のGoogleフォーム（今年もそのまま使用）』の実際の文言を正とする。募集人数は2026年度PDF按分（さくら町一丁目分）を正とする（フォームの古い人数は使わない）。",
  ...
  "events": [
    ...
    },
    {
      ...
      "scored": true,
      "description": "玉入れ",
      "_note": "去年フォームの内訳（1年2・2年1・3年2・未就学児1＝計6）とは異なる。2026年PDF按分（さくら町一丁目分）を正とする"
    },
    {
      "id": "e23",
      "name": "デカパンサッカー",
